...
public class Ex0514_03 {
	...
	public static void main(String[] args) {
		//3명의 배열 생성
		//학생 이름, 국어, 영어, 수학 성적을 입력받아--> 합계 ,평균을 출력
		...
		while(true) {
			...
			case 2://학생성적수정
				...
				System.out.println("수정할 학생입력하세요");
				check_name = scan.next(); //수정할 학생이름 입력
				
			    findnum = -1; //데이터가 없을 경우
			   
				for(int i=0; i<count; i++) {//check_name, name[i]비교
			...
			case 3:
				System.out.println("이름\t국어\t영어\t수학\t합계\t평균점수\n");
				System.out.println("---------------------------------");
