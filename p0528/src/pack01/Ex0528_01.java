...
public class Ex0528_01 {
	...
	public static void main(String[] args) {
		...
		while (true) {
			...
			case 1:
				// 입력은 메인메소드
				// 1.두수를 입력받아 2.더하는 계산을 해야한다.
				int result = p.add(num[0], num[1]);// 입력
				System.out.println("결과값 : " + result);
				break;

			case 2:
				// 1.두수를 입력받아 2.for문이용하여 3.더하기 계산을한다.
				// num[0],num[1]
			...
			case 3:
				// 1.두수를 입력받아 2.if문을 이용하여 3.비교하여 출력한다.
